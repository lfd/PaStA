...
RUN R -e "install.packages(c('assertthat', 'cowplot', 'dplyr', 'ggplot2', 'ggraph', 'ggplot2', 'graphlayouts', 'igraph', 'ineq', 'lubridate', 'reshape2', 'RColorBrewer', 'tikzDevice', 'TSdist', 'zoo'), Ncpus = 4, clean = TRUE, lib = '${R_LIBS_USER}')"
